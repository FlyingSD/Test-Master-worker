/**
 * Parent Login Page
 * Login page for parents with email/password and Google Sign-In
 */
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Влезте в профила си за достъп до информация за вашите деца
            </p>
          </div>
          ...
          >
            ...
            <span className="font-semibold text-gray-700">Влезте с Google</span>
          </button>
